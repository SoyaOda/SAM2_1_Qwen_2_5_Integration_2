...
〇本タスク：minimal_train.pyを進めた場合のSEG LOSSがほぼ下がらない問題がある。そこでGTP-5proにより修正方針をmd_files/current/Focus_Seg_Loss20250809_spec.mdに作成した。これを元に修正していきたい。まず問題1: テキスト指示の空間情報不足と修正策から始めて。
